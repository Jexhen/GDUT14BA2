    ...
    <div class="col-lg-6" style="background-color: #F9F9F9; border-radius: 5px; border: #e9e9e9 1px solid; ">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">启事详情</li>
            </ol>
        </div>
        <div class="row" style="padding: 0px 20px 10px;">
            <h3 style="text-align: center;"><s:property value="#employInfo.emp_info_title"/></h3>
            <div class="col-lg-12" style="border: 1px dashed #CCCCCC; color: #666666; text-align: center;">
                发布时间：<s:property value="#employInfo.emp_info_date"/>&nbsp;&nbsp;&nbsp;
                编辑：<s:property value="#employInfo.student.stu_name"/>&nbsp;&nbsp;&nbsp;
                阅读(<s:property value="#employInfo.emp_info_scan"/>)
            </div>
            <div class="col-lg-12" style="margin-top: 15px;">
                <s:property value="#employInfo.emp_info_content" escape="false"/>
            </div>
        </div>
    </div><!--左侧-->
    <!--右侧-->
...
<div id="item">
        ...
        <div style="margin: 20px 0px;">
            ...
            <span>
                <a href="${ pageContext.request.contextPath }/employmentAction_getEmployInfo?emp_info_id=<s:property value="#hotEmp[0].emp_info_id"/>"><s:property value="#hotEmp[0].emp_info_title"/></a>
            </span>
            <span style="color: #75B0B0;"><s:property value="#hotEmp[0].student.stu_name"/></span>
            <span style="color: #D8B092;"><s:property value="#hotEmp[0].emp_info_date"/></span>
        </div>
        <hr>
        <div class="row" style="margin: 10px 0px;">
            ...
            <span>
                <a href="${ pageContext.request.contextPath }/employmentAction_getEmployInfo?emp_info_id=<s:property value="#hotEmp[1].emp_info_id"/>"><s:property value="#hotEmp[1].emp_info_title"/></a>
            </span>
            <span style="color: #75B0B0;"><s:property value="#hotEmp[1].student.stu_name"/></span>
            <span style="color: #D8B092;"><s:property value="#hotEmp[1].emp_info_date"/></span>
        </div>
        <hr>
        <div class="row" style="margin: 10px 0px;">
            ...
            <span>
                <a href="${ pageContext.request.contextPath }/employmentAction_getEmployInfo?emp_info_id=<s:property value="#hotEmp[2].emp_info_id"/>"><s:property value="#hotEmp[2].emp_info_title"/></a>
            </span>
            <span style="color: #75B0B0;"><s:property value="#hotEmp[2].student.stu_name"/></span>
            <span style="color: #D8B092;"><s:property value="#hotEmp[2].emp_info_date"/></span>
        </div>
        <hr>
        <div class="row" style="margin: 10px 0px;">
            ...
            <span>
                <a href="${ pageContext.request.contextPath }/employmentAction_getEmployInfo?emp_info_id=<s:property value="#hotEmp[3].emp_info_id"/>"><s:property value="#hotEmp[3].emp_info_title"/></a>
            </span>
            <span style="color: #75B0B0;"><s:property value="#hotEmp[3].student.stu_name"/></span>
            <span style="color: #D8B092;"><s:property value="#hotEmp[3].emp_info_date"/></span>
        </div>
        <hr>
        <!--通知条目END-->
</div>
	    ...
	    $(".recommend").mouseover(
	        function() {
	            ...
	            if ($recommend==="栏目更新") {
	            	if (!updateFlag) {
	            		$.ajax({
	            			url:"${ pageContext.request.contextPath }/employmentAction_getRecentEmployInfo",
	            			type:"post",
	            			success:function(data){
	            				for (var i=0;i<data.length;i++){
	            			        ...
	            			        "\t            </span>\n" +
	            			        "\t            <span>\n" +
	            			        "\t                <a href=\"${ pageContext.request.contextPath }/noticeAction_getNotice?notice_id="+data[i].emp_info_id+"\">"+data[i].emp_info_title+"</a>\n" +
	            			        "\t            </span>\n" +
	            			        "\t            <span style=\"color: #75B0B0;\">"+data[i].student.stu_name+"</span>\n" +
	            			        "\t            <span style=\"color: #D8B092;\">"+data[i].emp_info_date+"</span>\n" +
	            			        "\t        </div>\n" +
	            			        "\t        <hr>";
	            				}
