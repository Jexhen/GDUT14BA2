    ...
    <div class="row" style="background-color:#EEEEEE;">
        ...
        <div class="col-lg-10">
            ...
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-12">
                    <form action="${ pageContext.request.contextPath }/adminAction_updateEmployInfo?emp_info_id=${ employInfo.emp_info_id }" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <div class="col-lg-2"><label for="emp_info_title">标题</label></div>
                            <div class="col-lg-10"><input type="text" class="form-control" id="emp_info_title" name="emp_info_title" value="<s:property value='#employInfo.emp_info_title'/>"></div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">
                                    <input class="form-control" size="16" type="text" id="emp_info_deadline" value="<s:property value='#employInfo.emp_info_deadline'/>" name="emp_info_deadline" readonly>
...
<script>
	$(function(){
	    ...
	    editor.create();
	    editor.txt.html('${ employInfo.emp_info_content }');
