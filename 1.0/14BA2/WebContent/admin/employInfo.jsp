...
<div class="container-fluid">
    ...
    <div class="row" style="background-color:#EEEEEE;">
        ...
        <div class="col-lg-10">
            ...
            <div class="row">
            	<form action="${ pageContext.request.contextPath }/adminAction_getEmployInfoBySearchCondition" method="post">
	               <div class="col-lg-2">
	                   <input type="text" class="form-control" name="emp_info_title" placeholder="按招聘启事标题搜索" value="<s:property value='emp_info_title'/>">
	               </div>
	               <div class="col-lg-2">
	               ...
	               <div class="col-lg-2">
                       <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">
                           <input class="form-control" size="16" type="text" id="notice_date" value="<s:property value='emp_info_date'/>" name="emp_info_date" placeholder="选择日期搜索" readonly>
                ...
                <div class="col-lg-3">
                    <a type="button" class="btn btn-success" href="${ pageContext.request.contextPath }/admin/addEmployInfo.jsp">新增招聘启示</a>
                </div>
            </div>
                ...
                <table class="table table-striped">
                   ...
                   <tbody>
                   	<s:iterator value="#page.list" var="member">
                   		<tr>
	                        <td><s:property value="#member.emp_info_title"/></td>
	                        <td><s:property value="#member.student.stu_name"/></td>
	                        <td><s:property value="#member.emp_info_date"/></td>
	                        <td>
	                            <a href="${ pageContext.request.contextPath }/adminAction_editEmployInfo?emp_info_id=${ member.emp_info_id }" target="_blank"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
	                        </td>
	                        <td>
	                            <a onclick="delEmployInfo(<s:property value='#member.emp_info_id'/>)"><i class="fa fa-times" aria-hidden="true"></i></a>
	                        </td>
	                    </tr>
            ...
            <div class="row" style="text-align:center;">
            	<nav aria-label="Page navigation">
				  ...
				  <s:if test="#page.currentPage==1">
				  	...
				  	<s:else>
				  		<li>
					      <a href="${ pageContext.request.contextPath }/adminAction_getEmployInfos?currentPage=${ page.currentPage-1 }&currentCount=" aria-label="Previous">
					        <span aria-hidden="true">&laquo;</span>
					      </a>
					    </li>
				  	</s:else>
				  <s:iterator begin="1" end="#page.totalPage" status="status">
				  	<s:if test="#status.count==#page.currentPage">
				  		<li class="active"><a href="${ pageContext.request.contextPath }/adminAction_getEmployInfos?currentPage=${ status.count }&currentCount="><s:property value='#status.count'/></a></li>
				  	</s:if>
				  	<s:else>
				  		<li><a href="${ pageContext.request.contextPath }/adminAction_getEmployInfos?currentPage=${ status.count }&currentCount="><s:property value='#status.count'/></a></li>
				  	</s:else>
				  </s:iterator>
				  <s:if test="#page.currentPage==#page.totalPage">
				  	...
				  	<s:else>
				  		<li>
					      <a href="${ pageContext.request.contextPath }/adminAction_getEmployInfos?currentPage=${ page.currentPage+1 }&currentCount=" aria-label="Next">
					        <span aria-hidden="true">&raquo;</span>
					      </a>
					    </li>
				  	</s:else>  
...
<script>
    ...
    function delEmployInfo(emp_info_id) {
    	$.ajax({
    		url:"${pageContext.request.contextPath}/adminAction_delEmployInfo",
    		data:{"emp_info_id":emp_info_id},
    		type:"post",
