    ...
    <div class="row" style="background-color:#EEEEEE;">
        ...
        <div class="col-lg-10">
            ...
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-12">
                    <form action="${ pageContext.request.contextPath }/adminAction_updateCarousel" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <div class="col-lg-2"><label for="crs_desc">图片描述</label></div>
                            <div class="col-lg-10"><input type="text" class="form-control" placeholder="请输入图片描述(可选)" name="crs_desc" value="<s:property value='#carousel.crs_desc'/>"></div>
                        	<input type="hidden" name="crs_id" value="<s:property value='#carousel.crs_id'/>">
                        </div>
